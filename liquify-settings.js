...
(() => {
  ...
  async function applyCustomBackground(file) {
    ...
    localStorage.setItem("liquify-bg-image", compressedBase64);
    updateBackground();
  }
  ...
  function installArtistBackgroundController() {
    ...
    const STORAGE_KEY_CUSTOM = "liquify-bg-image";
...
@keyframes yPSdY9z6bkI2272drRTw {
  ...
  var liquifyTranslations = {
    ...
    fr: {
      ...
      artistScrollBlur: "Flou de d\xE9filement de l\u2019artiste (px):",
      artistScrollBrightness: "Luminosit\xE9 de d\xE9filement de l\u2019artiste (%):",
  ...
  function SettingsContent(props) {
    ...
    const [accentMode, setAccentMode] = React.useState(readLS("liquify-accent-mode", "default"));
    ...
    )))), /* @__PURE__ */ React.createElement(Section, { title: titles.background }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.background), /* @__PURE__ */ React.createElement("div", { className: "liquifyStackedControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: bgMode,
        options: [
    ...
    )))), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.backgroundBlur), /* @__PURE__ */ React.createElement(Stepper, { value: bgBlur, min: 0, max: 40, onChange: applyBlur }))), /* @__PURE__ */ React.createElement(Section, { title: titles.artist }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.apbackground), /* @__PURE__ */ React.createElement("div", { className: "liquifyStackedControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: artistBgMode,
        options: [
    ...
    )))), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.artistScrollBlur), /* @__PURE__ */ React.createElement(Stepper, { value: artistScrollBlur, min: 0, max: 40, onChange: applyArtistBlur })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.artistScrollBrightness), /* @__PURE__ */ React.createElement(Stepper, { value: artistScrollBrightness, min: 0, max: 200, onChange: applyArtistBrightness }))), /* @__PURE__ */ React.createElement(Section, { title: titles.player }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.playerWidth), /* @__PURE__ */ React.createElement(
      Select,
      {
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.playerRadius), /* @__PURE__ */ React.createElement(Stepper, { value: playerRadius, min: 0, max: 100, onChange: applyRadius }))), /* @__PURE__ */ React.createElement(Section, { title: titles.playlist }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.playlistHeaderBox), /* @__PURE__ */ React.createElement(
      Select,
      {
  ...
  (async function initLiquifyStandaloneTs() {
    ...
    const savedAccentMode = localStorage.getItem("liquify-accent-mode") || "default";
