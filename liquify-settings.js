...
@keyframes yPSdY9z6bkI2272drRTw {
  ...
  function SettingsContent(props) {
    ...
    ))), ccaEnabled === "show" && /* @__PURE__ */ React.createElement("div", { className: "liquifySubBlock" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_o = t.comfyCoverArt) == null ? void 0 : _o.width) || "Width (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_p = t.tooltips) == null ? void 0 : _p.ccaWidth })), /* @__PURE__ */ React.createElement(Stepper, { value: ccaWidth, min: 16, max: 200, onChange: (v2) => {
      setCcaWidth(v2);
      localStorage.setItem(CCA_WIDTH_KEY, String(v2));
      applyComfyCoverArt();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_q = t.comfyCoverArt) == null ? void 0 : _q.height) || "Height (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_r = t.tooltips) == null ? void 0 : _r.ccaHeight })), /* @__PURE__ */ React.createElement(Stepper, { value: ccaHeight, min: 16, max: 200, onChange: (v2) => {
      setCcaHeight(v2);
      localStorage.setItem(CCA_HEIGHT_KEY, String(v2));
      applyComfyCoverArt();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_s = t.comfyCoverArt) == null ? void 0 : _s.marginBottom) || "Margin Bottom (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_t = t.tooltips) == null ? void 0 : _t.ccaMarginBottom })), /* @__PURE__ */ React.createElement(Stepper, { value: ccaMarginBottom, min: -50, max: 200, onChange: (v2) => {
      setCcaMarginBottom(v2);
      localStorage.setItem(CCA_MARGIN_BOTTOM_KEY, String(v2));
      applyComfyCoverArt();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_u = t.comfyCoverArt) == null ? void 0 : _u.marginLeft) || "Margin Left (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_v = t.tooltips) == null ? void 0 : _v.ccaMarginLeft })), /* @__PURE__ */ React.createElement(Stepper, { value: ccaMarginLeft, min: -50, max: 200, onChange: (v2) => {
      setCcaMarginLeft(v2);
      localStorage.setItem(CCA_MARGIN_LEFT_KEY, String(v2));
      applyComfyCoverArt();
    } })))), /* @__PURE__ */ React.createElement(Section, { title: titles.nextSongCard || "Next Song Card" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_w = t.nextSongCard) == null ? void 0 : _w.show) || "Show Next Song Card:", /* @__PURE__ */ React.createElement(Tooltip, { text: (_x = t.tooltips) == null ? void 0 : _x.nscShow })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: nscShow,
        options: [
          { value: "show", label: ((_y = t.dropdown) == null ? void 0 : _y.show) || "Show" },
          { value: "hide", label: ((_z = t.dropdown) == null ? void 0 : _z.hide) || "Hide" }
        ],
        onChange: (v2) => {
          setNscShow(v2);
    ...
    ))), nscShow === "show" && /* @__PURE__ */ React.createElement("div", { className: "liquifySubBlock" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_A = t.nextSongCard) == null ? void 0 : _A.position) || "Horizontal Position", /* @__PURE__ */ React.createElement(Tooltip, { text: (_B = t.tooltips) == null ? void 0 : _B.nscPosition })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: nscPosition,
        options: [
          { value: "left", label: ((_C = t.nextSongCard) == null ? void 0 : _C.left) || "Left" },
          { value: "right", label: ((_D = t.nextSongCard) == null ? void 0 : _D.right) || "Right" }
        ],
        onChange: (v2) => {
          setNscPosition(v2);
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_E = t.nextSongCard) == null ? void 0 : _E.cardHeight) || "Card Height (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_F = t.tooltips) == null ? void 0 : _F.nscHeight })), /* @__PURE__ */ React.createElement(Stepper, { value: nscHeight, min: 32, max: 200, onChange: (v2) => {
      setNscHeight(v2);
      localStorage.setItem(NSC_HEIGHT_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_G = t.nextSongCard) == null ? void 0 : _G.cardMaxWidth) || "Card Max Width (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_H = t.tooltips) == null ? void 0 : _H.nscMaxWidth })), /* @__PURE__ */ React.createElement(Stepper, { value: nscMaxWidth, min: 100, max: 600, onChange: (v2) => {
      setNscMaxWidth(v2);
      localStorage.setItem(NSC_MAX_WIDTH_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_I = t.nextSongCard) == null ? void 0 : _I.gap) || "Gap between Image and Text (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_J = t.tooltips) == null ? void 0 : _J.nscGap })), /* @__PURE__ */ React.createElement(Stepper, { value: nscGap, min: 0, max: 24, onChange: (v2) => {
      setNscGap(v2);
      localStorage.setItem(NSC_GAP_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_K = t.nextSongCard) == null ? void 0 : _K.coverSize) || "Cover Size (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_L = t.tooltips) == null ? void 0 : _L.nscCoverSize })), /* @__PURE__ */ React.createElement(Stepper, { value: nscCoverSize, min: 16, max: 128, onChange: (v2) => {
      setNscCoverSize(v2);
      localStorage.setItem(NSC_COVER_SIZE_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_M = t.nextSongCard) == null ? void 0 : _M.hPad) || "Horizontal Padding (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_N = t.tooltips) == null ? void 0 : _N.nscHPad })), /* @__PURE__ */ React.createElement(Stepper, { value: nscHPad, min: 0, max: 32, onChange: (v2) => {
      setNscHPad(v2);
      localStorage.setItem(NSC_HPAD_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_O = t.nextSongCard) == null ? void 0 : _O.vPad) || "Vertical Padding (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_P = t.tooltips) == null ? void 0 : _P.nscVPad })), /* @__PURE__ */ React.createElement(Stepper, { value: nscVPad, min: 0, max: 32, onChange: (v2) => {
      setNscVPad(v2);
      localStorage.setItem(NSC_VPAD_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_Q = t.nextSongCard) == null ? void 0 : _Q.gapToPlayer) || "Distance to Player (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_R = t.tooltips) == null ? void 0 : _R.nscGapToPlayer })), /* @__PURE__ */ React.createElement(Stepper, { value: nscGapToPlayer, min: 0, max: 40, onChange: (v2) => {
      setNscGapToPlayer(v2);
      localStorage.setItem(NSC_GAP_PLAYER_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_S = t.nextSongCard) == null ? void 0 : _S.borderRadius) || "Border Radius (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_T = t.tooltips) == null ? void 0 : _T.nscBorderRadius })), /* @__PURE__ */ React.createElement(Stepper, { value: nscBorderRadius, min: 0, max: 50, onChange: (v2) => {
      setNscBorderRadius(v2);
      localStorage.setItem(NSC_BORDER_RADIUS_KEY, String(v2));
      fireNscUpdate();
    } })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow", style: { margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, ((_U = t.nextSongCard) == null ? void 0 : _U.coverBorderRadius) || "Cover Border Radius (px)", /* @__PURE__ */ React.createElement(Tooltip, { text: (_V = t.tooltips) == null ? void 0 : _V.nscCoverBorderRadius })), /* @__PURE__ */ React.createElement(Stepper, { value: nscCoverBorderRadius, min: 0, max: 50, onChange: (v2) => {
      setNscCoverBorderRadius(v2);
      localStorage.setItem(NSC_COVER_BORDER_RADIUS_KEY, String(v2));
      fireNscUpdate();
    } })))), /* @__PURE__ */ React.createElement(Section, { title: titles.playlist }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.playlistHeaderBox, /* @__PURE__ */ React.createElement(Tooltip, { text: (_W = t.tooltips) == null ? void 0 : _W.playlistHeaderBox })), /* @__PURE__ */ React.createElement(
      Select,
      {
    ...
    ))), /* @__PURE__ */ React.createElement(Section, { title: titles.lyrics || "Lyrics" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.lyricsMode || "Lyrics Translation/Romanization:", /* @__PURE__ */ React.createElement(Tooltip, { text: (_X = t.tooltips) == null ? void 0 : _X.lyricsMode })), /* @__PURE__ */ React.createElement("div", { className: "liquifyRowControls" }, /* @__PURE__ */ React.createElement(
      Select,
      {
        value: lyricsMode,
        options: [
          { value: "off", label: ((_Y = t.lyricsOptions) == null ? void 0 : _Y.off) || "Off" },
          { value: "translation", label: ((_Z = t.lyricsOptions) == null ? void 0 : _Z.translation) || "Translation only" },
          { value: "romanization", label: ((__ = t.lyricsOptions) == null ? void 0 : __.romanization) || "Romanization only" },
          { value: "both", label: ((_$ = t.lyricsOptions) == null ? void 0 : _$.both) || "Translation + Romanization" }
        ],
        onChange: applyLyricsMode
      }
    )))), /* @__PURE__ */ React.createElement(Section, { title: titles.transparent }, /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.transparentWidth, /* @__PURE__ */ React.createElement(Tooltip, { text: (_aa = t.tooltips) == null ? void 0 : _aa.transparentWidth })), /* @__PURE__ */ React.createElement("div", { style: { opacity: unixLike ? 0.5 : 1, pointerEvents: unixLike ? "none" : "auto" } }, /* @__PURE__ */ React.createElement(Stepper, { value: tcW, min: 0, max: 400, onChange: (v2) => applyTransparent(v2, tcH) }))), /* @__PURE__ */ React.createElement("div", { className: "liquifyRow" }, /* @__PURE__ */ React.createElement("div", { className: "liquifyLabel" }, t.transparentHeight, /* @__PURE__ */ React.createElement(Tooltip, { text: (_ba = t.tooltips) == null ? void 0 : _ba.transparentHeight })), /* @__PURE__ */ React.createElement("div", { style: { opacity: unixLike ? 0.5 : 1, pointerEvents: unixLike ? "none" : "auto" } }, /* @__PURE__ */ React.createElement(Stepper, { value: tcH, min: 0, max: 300, onChange: (v2) => applyTransparent(tcW, v2) }))))));
  }
